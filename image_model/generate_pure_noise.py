    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            out_dir = os.path.abspath(os.path.join(os.path.curdir, 
                                                   "results_pure_noise/models/"+ model_name))
            checkpoint_dir = os.path.abspath(os.path.join(out_dir, "checkpoints"))
            checkpoint_prefix = os.path.join(checkpoint_dir, "model")
            if not os.path.exists("results_pure_noise/generated/"):
                os.makedirs("results_pure_noise/generated/")           
            ...
            outfile = "results_pure_noise/generated/{}".format(model_name)
...
def generate_multi():
    pathes = os.listdir("results_pure_noise/models/")
    for path in pathes:
        info = path.split('_')
        dataset = info[0]
        model_name = path
